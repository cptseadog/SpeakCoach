...
class Config:
    ...
    # chat mode: 'local' (Ollama) or 'api' (any OpenAI-compatible provider)
    chat_backend: str = field(default_factory=lambda: os.environ.get("CHAT_BACKEND", "local"))
    chat_api_base_url: str = field(default_factory=lambda: os.environ.get("CHAT_API_BASE_URL", ""))
    chat_api_key: str = field(default_factory=lambda: os.environ.get("CHAT_API_KEY", ""))
    chat_api_model: str = field(default_factory=lambda: os.environ.get("CHAT_API_MODEL", ""))
